 ...
 *
 * <p>
 * Uses {@link GenericJackson2JsonRedisSerializer} with a custom
 * {@link ObjectMapper}
 * that:
 * <ul>
 ...
 *
 * <p>
 * Keys are plain UTF-8 strings (e.g. {@code "client:42"},
 * {@code "email:foo@bar.com"}).
 *
 * <p>
 * {@code @ConditionalOnBean(RedisConnectionFactory.class)} ensures this bean is
 * only
 * created when a real Redis connection is available (i.e. in production /
 * integration tests).
 * In smoke tests that exclude {@code RedisAutoConfiguration}, a
 * {@code @MockBean} substitute
 * is provided instead.
 */
@Configuration
